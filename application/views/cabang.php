            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Tabel Cabang</h4>
                        ...
                        <div class="card">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($cabang as $key ) { ?>
                                    <tr>
                                        <td><?php echo $key->idCabang ?></td>
                                        <td><?php echo $key->username ?></td>
                                        <td><?php echo $key->password ?></td>
                                        <td><?php echo $key->kota ?></td>
                                        <td><?php echo $key->telepon ?></td>
                                        <td><a href="<?php echo site_url()?>/Server/getPengiriman/<?php echo $key->idCabang; ?>"><button class="btn btn-primary">pengiriman</button></a> <a href="<?php echo site_url()?>/Server/getKurir/<?php echo $key->idCabang; ?>"><button class="btn btn-primary">kurir</button></a></td>
                                        <td>
                                            <a href="javascript:void(0);" 
                                            onclick="showmodal('<?php echo $key->idCabang ?>','<?php echo $key->username ?>','<?php echo $key->password ?>','<?php echo $key->kota ?>','<?php echo $key->telepon ?>')" 
                                                data-toggle="modal" 
                                                data-target="#myModalEdit"><button class="btn btn-secondary">Update</button></a>
                                            <a href="<?php echo site_url()?>/Server/deleteCabang/<?php echo $key->idCabang; ?>" onclick="return confirm('Are you sure to delete this data permanently?');"><button class="btn btn-warning">Delete</button></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                            </tbody>
